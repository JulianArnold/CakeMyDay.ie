...
class ProductImagesControllerTest < ActionController::TestCase
  ...
  test "should create product_image" do
    assert_difference('ProductImage.count') do
      post :create, product_image: { image_id: @product_image.image_id, product_id: @product_image.product_id, running_order: @product_image.running_order }
    end
  ...
  test "should update product_image" do
    put :update, id: @product_image, product_image: { image_id: @product_image.image_id, product_id: @product_image.product_id, running_order: @product_image.running_order }
    assert_redirected_to product_image_path(assigns(:product_image))
  end
