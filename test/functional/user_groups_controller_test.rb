...
class UserGroupsControllerTest < ActionController::TestCase
  ...
  test "should update user_group" do
    put :update, id: @user_group, user_group: { description: @user_group.description, is_a_manager: @user_group.is_a_manager, is_an_admin: @user_group.is_an_admin, name: @user_group.name }
    assert_redirected_to user_group_path(assigns(:user_group))
  end
