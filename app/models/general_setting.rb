class GeneralSetting < ActiveRecord::Base
  ...
  validates_presence_of :aws_bucket_name, :customer_service_email_address, :customer_service_phone_number, :default_value_for_weekly_production_quota, :rbn_number
